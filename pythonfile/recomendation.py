...
df = pd.read_csv('../pythonfile/training.csv')
Df = pd.read_csv('../pythonfile/training.csv', index_col='prognosis')
tr = pd.read_csv('../pythonfile/testing.csv')
...
tree_, random, naives, knn, accuracy = tree_model(arr)
